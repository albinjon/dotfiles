...
-- Colmak bindings
vim.keymap.set({ 'n', 'x', 'o', 'v' }, 'n', 'j')
vim.keymap.set({ 'n', 'x', 'o', 'v' }, 'e', 'k')
vim.keymap.set({ 'n', 'x', 'o', 'v' }, 'i', 'l')
vim.keymap.set({ 'n', 'x', 'o', 'v' }, 'k', '<cmd>norm! n<CR>')
vim.keymap.set({ 'n', 'x', 'o', 'v' }, 'K', '<cmd>norm! N<CR>')
vim.keymap.set({ 'n', 'x', 'o', 'v' }, 'j', '<cmd>norm! e<CR>')
vim.keymap.set({ 'n', 'x', 'o', 'v' }, 'J', '<cmd>norm! E<CR>')
vim.keymap.set({ 'n', 'x', 'o', 'v' }, 'k', '<cmd>norm! n<CR>')
-- vim.keymap.set({ 'n' }, 'l', '<cmd>norm! i<CR>')
